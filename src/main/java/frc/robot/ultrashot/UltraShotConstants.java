...
public class UltraShotConstants {
    ...
    public static Point3D blueTarget = new Point3D((11*0.0254), 5.547868, 2.06986103781);
    public static Point3D redTarget = new Point3D(((651.25-11)*0.0254), 5.547868, 2.06986103781);

    public static AngleStates states = new AngleStates();

    public static double shooterLength = 0.4303; // m
    public static double shooterSpeed = 10.5; // m/s
    public static double localGravity = 9.79327; // m/s^2
    public static double airDrag = 1.276; // unitless
    public static double settleTime = 0.0; // s
